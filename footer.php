                ...
                <div class="hof-section-padding hof-bg-brown">
                    <div class="d-flex flex-column flex-xl-row justify-content-between hof-color-white">
                        ...
                        <div class="order-2 order-xl-5 mb-5 mb-xl-0 mx-auto mx-xl-0 text-center text-xl-left d-flex flex-column">
                            ...
                            <div class="">
                                <form action="https://byablo.us8.list-manage.com/subscribe/post?u=966a983115dc44d6768748ad7&amp;id=711248dc13&amp;f_id=007403e0f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate d-flex" target="_blank" novalidate>
