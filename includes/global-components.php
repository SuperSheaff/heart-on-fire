 ...
 * @return array
 */
function heartonfire_change_the_component_field($componentFields)
{
    $fieldNames = array();
    $count = 1;
    $groups = array();
 ...
 * @return array
 */
function heartonfire_get_the_global_components($component)
{
 ...
 * @return mixed
 */
function heartonfire_get_the_field_values($globalComponent, $compName, $fieldName)
{
